...
- INTEREST BALANCE (strictly enforced): one is the floor, not the target, and no single interest may take more than about a third of the plan's activities. Four interests across eight activities means roughly two each. Four temples, one shopping street and nothing else is a failure even though every stop is real, because three of the four things the traveller asked for got one mention and the fourth got everything. When one interest keeps suggesting itself because the city is famous for it, that is precisely the moment to stop and give the others their share.
